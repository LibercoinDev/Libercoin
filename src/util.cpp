...
int nAnonymizeLibercoinAmount = 500;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Libercoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Libercoind.pid"));
