...
{
    int64_t nGenesisBlockRewardCoin = 248000 * COIN;
    int64_t nBlockRewardStartCoin = 5 * COIN;
    int64_t nBlockReward2hCoin = 2.5 * COIN;
    int64_t nBlockReward3hCoin = 1.25 * COIN;
    int64_t nBlockReward4hCoin = 0.625 * COIN;
    int64_t nBlockReward5hCoin = 0.3125 * COIN;
    int64_t nBlockReward6hCoin = 0.15625 * COIN;
    int64_t nBlockReward7hCoin = 0.078125 * COIN;
    int64_t nBlockReward8hCoin = 0.0390625 * COIN;
    int64_t nBlockReward9hCoin = 0.01953125 * COIN;
    int64_t nBlockRewardMinimumCoin = 0 * COIN;
