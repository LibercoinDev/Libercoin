...
Value checkkernel(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "Libercoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "Libercoin is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Libercoin is downloading blocks...");
