...
private slots:
    ...
    QString BuyLibercoin(QString OrderType, double Quantity, double Rate);
    QString SellLibercoin(QString OrderType, double Quantity, double Rate);
    ...
    QJLibercoinbject GetResultObjectFromJLibercoinbject(QString response);
    QJLibercoinbject GetResultObjectFromJSONArray(QString response);
    QJsonArray  GetResultArrayFromJLibercoinbject(QString response);
