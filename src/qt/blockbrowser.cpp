...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " Libercoin");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " Libercoin");
    }
}
...
void BlockBrowser::updateStatistics()
{
    ...
    double nGenesisBlockRewardCoin = 248000;
    double nBlockRewardStartCoin = 5;
    double nBlockReward2hCoin = 2.5;
    double nBlockReward3hCoin = 1.25;
    double nBlockReward4hCoin = 0.625;
    double nBlockReward5hCoin = 0.3125;
    double nBlockReward6hCoin = 0.15625;
    double nBlockReward7hCoin = 0.078125;
    double nBlockReward8hCoin = 0.0390625;
    double nBlockReward9hCoin = 0.01953125;
    double nBlockRewardMinimumCoin = 0;
    double nSubsidy = 1;
    ...
    QString phase = "";
    if (pindexBest->nHeight <= 165772800)
    {
        phase = "Hybrid consensus";
    }
    else if (pindexBest->nHeight > 165772800)
    {
        phase = "PoS 3.0 consensus";
    }
    ...
    {
        ui->volumeBox_2->setText("<b><font color=\"green\">" + qVolume + " Libercoin" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox_2->setText("<b><font color=\"red\">" + qVolume + " Libercoin" + "</font></b>");
    } else {
        ui->volumeBox_2->setText(qVolume + " Libercoin");
    }
