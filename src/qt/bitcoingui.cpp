    ...
    nWeight(0)
{
    //resize(970, 570);
	resize(1080, 662);
    setWindowTitle(tr("Libercoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("Libercoin");
    setStyleSheet("#Libercoin {background-image: url(:/images/qt) }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Libercoin address"));
    ...
    masternodeManagerAction->setToolTip(tr("Show Libercoin Masternodes status and configure your nodes."));
...
/*
    ...
    generateAction->setToolTip(tr("Libercoin mining and staking management"));
...
*/
  ...
  /*  TradingAction = new QAction(tr("&Trade"), this);
   ...
   // connect(clientcontrolAction, SIGNAL(triggered()), this, SLOT(gotoClientControlPage()));
    ...
    aboutAction = new QAction(tr("&About Libercoin"), this);
    aboutAction->setToolTip(tr("Show information about Libercoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Libercoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Libercoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Libercoin client"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Libercoin address or malformed URI parameters."));
    }
