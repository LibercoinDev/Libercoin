...
static const int64_t DARKSEND_COLLATERAL = (0.5*COIN); //1 Libercoin
static const int64_t DARKSEND_FEE = (0.00001*COIN);
static const int64_t DARKSEND_POOL_MAX = (1000*COIN);
...
static const unsigned int MAX_STANDARD_TX_SIZE = MAX_BLOCK_SIZE_GEN/4;
...
static const unsigned int DEFAULT_MAX_ORPHAN_BLOCKS = 1440;
...
static const uint64_t nMinDiskSpace = 1024*1024*1024;
...
public:
    ...
    {
		return LiberHash5(BEGIN(nVersion), END(nNonce));
    }
